	           ...
	           "columnDefs":[
							{
							 ...
							 },
				   			{
								   "render":function(data,type,row,meta){
									   var html="";
                                       var name=row.hospitalName;
									   if(row.userName=="" || row.userName==null){
										   name=row.hospitalName;
									   }
									   html="<span style='display:inline-block;text-align:left;float:left;width:200px;max-width:200px; white-space:nowrap; text-overflow:ellipsis; -o-text-overflow:ellipsis; overflow:hidden;' title='"+name+"'>"+name+"</span>";
									   return html;
									 //  var html="";
           ...
           "columnDefs":[
						 ...
						 },
						{
						 ...
						 },
			             {
						   "render":function(data,type,row,meta){
							   var html="";
							   html="<span style='display:inline-block;text-align:left;max-width:500px;white-space:nowrap; text-overflow:ellipsis; -o-text-overflow:ellipsis; overflow:hidden;' title='"+row.content+"'>"+row.content+"</span>";
							   return html;	
						   },
						   "targets":3
					    },
