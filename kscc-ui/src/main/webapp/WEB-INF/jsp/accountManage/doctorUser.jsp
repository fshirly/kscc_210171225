            ...
            <div class="modal-body pl-p15">
                <form id="doctorFormAdd" method="post" action="">
            		<div class="clearfix mt-10">
			            ...
			            <input class="form-control form-width" id="doctorNameAdd" role="{required:true,zhLength:20}"><dfn>*</dfn>
			        </div>
			        <div class="clearfix mt-10">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pl-p15">
                <form id="doctorFormEdit" method="post" action="">
            		<div class="clearfix mt-10">
			            <label class="text-right">医生姓名：</label>
			            <input class="form-control form-width" id="doctorNameEdit" role="{required:true,zhLength:20}"><dfn>*</dfn>
			        </div>
			        <div class="clearfix mt-10">
			            <label class="text-right">身份证号：</label>
