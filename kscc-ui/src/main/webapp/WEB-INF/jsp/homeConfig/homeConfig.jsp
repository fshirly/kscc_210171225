...
%>
	...
	display:inline-block;
	      ...
	      <div class="middleContent heightFull">
                <div id="carouselItem" class="carousel slide" style="padding: 0 45px;position: relative">
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <div class="uploadPictures clearfix mb-5">
                                <div class="col-xs-6 col-sm-6 col-md-6 uploadDiv clearfix" style="float:left;">
                                    <form role="form" id="uploadPicFormFive" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/liveBroadCastController/addHomePicture">
                                        <input type="hidden" name="createId"/>
                                        <div class="imgUpDiv">
                                            <div class="set-middle-box">
                                                <div class="imgPreview">
                                                    <img src="${pageContext.request.contextPath}/images/no-image.png" id="imgPreviewFive" flag="0">
                                                    <div class="btn-box">
                                                        <label class="btn btn-primary btnUpload"  id="imgBtnFive" for="pictureInputFive" box="imgPreviewFive">上传图片</label>
                                                        <input type="file" class="form-control form-width" name="file" id ="pictureInputFive" value="" accept="image/jpg,image/png" />
                                                    </div>
                                                </div>
                                                <div class="row-fluid tip-style">* 建议上传宽度为1140px且高度为380px的图片</div>
                                            </div>
                                        ...
                                        <div class="row-fluid clearfix forms-box">
                                            <div class="left-input-box">
                                                ...
                                                <div class="form-inline">
                                                    <label class="text-center" for="networkUrl">URL链接:</label>
                                                    <input type="text" class="form-control" name="networkUrl" id ="networkUrlFive" value="" />
                                                </div>
                                            </div>
                                            <div class="right-btn-box text-center">
                                                <button type="button" class="btn btn-primary imgSubmit" id="imgSubmitFive" num="4">提交</button>
                                                <button type="button" class="btn btn-default imgCancel imgCancel_1" pos="1" style="margin-left:5px;">取消</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 uploadDiv" style="float:right;">
                                    <form role="form" id="uploadPicFormSix" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/liveBroadCastController/addHomePicture">
                                        <div class="imgUpDiv">
                                            <div class="set-middle-box">
                                                <div class="imgPreview">
                                                    <img id="imgPreviewSix" src="${pageContext.request.contextPath}/images/no-image.png"  flag="0" />
                                                    <div class="btn-box">
                                                        <label class="btn btn-primary btnUpload"  id="imgBtnSix" for="pictureInputSix" box="imgPreviewSix">上传图片</label>
                                                        <input type="file" class="form-control form-width" name="file" id ="pictureInputSix" value="" accept="image/jpg,image/png" />
                                                    </div>
                                                </div>
                                                <div class="row-fluid tip-style">* 建议上传宽度为1140px且高度为380px的图片</div>
                                            </div>
                                        ...
                                        <div class="row-fluid clearfix forms-box">
                                            <div class="left-input-box">
                                                ...
                                                <div class="form-inline">
                                                    <label class="text-center" for="urlLinkSecond">URL链接:</label>
                                                    <input type="text" class="form-control" name="networkUrl" id ="networkUrlSix" value="" />
                                                </div>
                                            </div>
                                            <div class="right-btn-box text-center">
                                                <button type="button" class="btn btn-primary imgSubmit" id="imgSubmitSix" num="5">提交</button>
                                                <button type="button" class="btn btn-default imgCancel imgCancel_2" pos="2" style="margin-left:5px;">取消</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="uploadPictures">
                                <div class="col-xs-6 col-sm-6 col-md-6 uploadDiv" style="float:left;">
                                    <form role="form" id="uploadPicFormSeven" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/liveBroadCastController/addHomePicture">
                                        <div class="imgUpDiv">
                                            <div class="set-middle-box">
                                                <div class="imgPreview">
                                                    <img id="imgPreviewSeven" src="${pageContext.request.contextPath}/images/no-image.png" flag="0" />
                                                    <div class="btn-box">
                                                        <label class="btn btn-primary btnUpload"  id="imgBtnSeven"  for="pictureInputSeven" box="imgPreviewSeven">上传图片</label>
                                                        <input type="file" class="form-control" name="file" id ="pictureInputSeven" value="" accept="image/jpg,image/png" />
                                                    </div>
                                                </div>
                                                <div class="row-fluid tip-style">* 建议上传宽度为1140px且高度为380px的图片</div>
                                            </div>
                                        ...
                                        <div class="row-fluid clearfix forms-box">
                                            <div class="left-input-box">
                                                ...
                                                <div class="form-inline">
                                                    <label class="text-center" for="urlLinkThree">URL链接:</label>
                                                    <input type="text" class="form-control" name="networkUrl" id ="networkUrlSeven" value="" />
                                                </div>
                                            </div>
                                            <div class="right-btn-box text-center">
                                                <button type="button" class="btn btn-primary imgSubmit" id="imgSubmitSeven" num="6">提交</button>
                                                <button type="button" class="btn btn-default imgCancel imgCancel_3" pos="3" style="margin-left:5px;">取消</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 uploadDiv" style="float:right;">
                                    <form role="form" id="uploadPicFormEight" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/liveBroadCastController/addHomePicture">
                                        <div class="imgUpDiv">
                                            <div class="set-middle-box">
                                                <div class="imgPreview">
                                                    <img id="imgPreviewEight" src="${pageContext.request.contextPath}/images/no-image.png"  flag="0" />
                                                    <div class="btn-box">
                                                        <label class="btn btn-primary btnUpload"  id="imgBtnEight" for="pictureInputEight" box="imgPreviewEight">上传图片</label>
                                                        <input type="file" class="form-control" name="file" id ="pictureInputEight" value="" accept="image/jpg,image/png" />
                                                    </div>
                                                </div>
                                                <div class="row-fluid tip-style">* 建议上传宽度为1140px且高度为380px的图片</div>
                                            </div>
                                        ...
                                        <div class="row-fluid clearfix forms-box">
                                            <div class="left-input-box">
                                                ...
                                                <div class="form-inline">
                                                    <label class="text-center" for="networkUrlForth">URL链接:</label>
                                                    <input type="text" class="form-control" name="networkUrl" id ="networkUrlEight" value="" />
                                                </div>
                                            </div>
                                            <div class="right-btn-box text-center">
                                                <button type="button" class="btn btn-primary imgSubmit" id="imgSubmitEight" num="7">提交</button>
                                                <button type="button" class="btn btn-default imgCancel imgCancel_4" pos="4" style="margin-left:5px;">取消</button>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <a class="carousel-control left" href="#carouselItem" data-slide="prev"></a>
                    <a class="carousel-control right" href="#carouselItem" data-slide="next" ></a>
                    <%--<ol class="carousel-indicators">--%>
                        <%--<li data-target="#carouselItem" data-slider-to="0" class="active"></li>--%>
                        <%--<li data-target="#carouselItem" data-slider-to="1"></li>--%>
                    <%--</ol>--%>
                </div>
