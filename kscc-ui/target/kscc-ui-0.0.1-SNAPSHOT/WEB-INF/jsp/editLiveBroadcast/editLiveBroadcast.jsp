	   ...
	   <form role="form" id="editLiveForm" method="post" enctype="multipart/form-data" action="">
		   ...
		   <div style="width: 400px;float:left;position:absolute;left:0;z-index:999">
			   ...
			   <input type="hidden" name="departmentOld" id="departmentOld">
				<div class="participantsList mb-10 partiFirst" style="width: 303px;"><span>步骤1：</span>基本信息</div>
				<div class="form-group">
					<label class="text-center" for="liveName">直播名称:</label>
					<input type="text" class="form-control form-width" name="liveName"  id="liveName" placeholder="请输入名称" role="{required:true,zhLength:40}"><dfn>*</dfn>
		  ...
		  <div  style="width:400px;float:right;position:absolute;right:0;z-index:999" id="addImgDiv">
		     <div class="participantsList mb-10 partiThird"><span>步骤3：</span>直播简介</div>
		     <div class="form-group">
				<label class="text-center" for="liveIntroduction" style="display:inline-block;vertical-align:top;width:100px">直播简介:</label>
		  ...
		  <div class="formButton" style="position: absolute">
