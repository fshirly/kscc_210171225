					...
					if(selectLiId!=belongId){
						...
						$.each(nodesObj,function(i,v){
							if(i==0){
								...
								v.serialnumber=2;
								$("#selectResult").append("<li att='"+v.hospitalId+"' class='partisLimodal'><span class='iconfont iconfontList'>&#xe61e;</span><span class='selectSpan' title='"+v.hospitalName+"'>"+v.hospitalName+"</span></li>");//<span class='iconfont iconfontImg' title='第二主持人'>&#xe61c;</span>
							}else{
								v.serialnumber=3;
	                	 ...
	                	 if(ids.length==0){
	                		...
	                		$("#selectResult").append("<li class='partisLimodal' att='"+effectiveList[0].id+"'><span class='iconfont iconfontList'>&#xe61e;</span><span class='selectSpan' title='"+effectiveList[0].hospitalName+"'>"+effectiveList[0].hospitalName+"</span><span class='iconfont iconfontImg' style='color:#ee453b;' title='第一主持人'>&#xe61c;</span></li>");
	                		 ...
	                		 if($.inArray(effectiveList[0].id.toString(),ids)==-1){
	 		                		...
	 		                		$("#selectResult").append("<li att='"+effectiveList[0].id+"' class='partisLimodal'><span class='iconfont iconfontList'>&#xe61e;</span><span class='selectSpan' title='"+effectiveList[0].hospitalName+"'>"+effectiveList[0].hospitalName+"</span></li>");//<span class='iconfont iconfontImg' title='第二主持人'>&#xe61c;</span>
 		                	 }else{
