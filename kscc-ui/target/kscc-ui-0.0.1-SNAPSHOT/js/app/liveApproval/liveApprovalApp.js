...
//                          $.extend(d,params); 
	           ...
	           "columnDefs":[
			              ...
			              {"render":function(data,type,row,meta){
                                  ...
                                  var editStatus="";
							      var fileDownload="";
							      if(row.filePath && row.file_name){
									  fileDownload="<div style='margin-left:3px;display:inline-block;'><a class='btn btn-link' href='"+$.base+'/fileUpload/download?fileUrl='+row.filePath+'&fileName='+row.file_name+"' title='下载附件'><i class='iconfont tableIcon' title='下载附件'>&#xe65b;</i></a></div>"
								 }else{
									  fileDownload="<div style='margin-left:3px;display:inline-block;'><a class='btn btn-link' disabled><i class='iconfont tableIcon' title='无附件'>&#xe65b;</i></a></div>"
								  }
							  	  //var url =""
                                  ...
                                  html =  "<div class='clearfix'>" +
									  ...
									  fileDownload+
	                            	  "<div style='margin-left:3px;display:inline-block;'><button class='btn btn-link download' rowId='"+row.id+"' user_Id='"+row.userId+"'><i class='iconfont tableIcon' title='下载详情'>&#xe621;</i></button></div>"+
						...
						$("#searchBtnView").on("click",function(){
							...
							$.each(container,function(i,v){
								if(v.serialNumber==1){
									...
									$("#liveParticipant").append("<li att='"+v.hospitalId+"' class='participantsLi'><span class='iconfont iconfontList'>&#xe61e;</span><span class='controlParti' title='"+v.name+"'>"+v.name+"</span></li>");//<span class='iconfont iconfontImg' title='第二主持人'>&#xe61c;</span>
								}
								else{
